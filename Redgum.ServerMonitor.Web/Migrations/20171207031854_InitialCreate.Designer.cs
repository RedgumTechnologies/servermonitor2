...
namespace Redgum.ServerMonitor.Web.Migrations
{
    ...
    [Migration("20171207031854_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Redgum.ServerMonitor.Web.ServerMonitor.Data.ServerDataAgregateDataModel", b =>
                {
                    ...
                    b.Property<int?>("ServerDataModelId");

                    b.HasKey("Id");

                    b.HasIndex("ServerDataModelId");
            ...
            modelBuilder.Entity("Redgum.ServerMonitor.Web.ServerMonitor.Data.ServerDataAgregateDataModel", b =>
                {
                    b.HasOne("Redgum.ServerMonitor.Web.ServerMonitor.Data.ServerDataModel")
                        .WithMany("DataAggregate")
                        .HasForeignKey("ServerDataModelId");
                });
